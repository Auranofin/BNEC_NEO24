...
class ParticipantController extends Controller
{
    ...
    public function index()
    {
        ...
        $participantsNewscasting = Participant::whereHas('registrationDetail', function ($query) {
            $query->whereRelation('competition', 'name', 'Essaywriting')->whereHas('verifiedPayment');
        })->get(['id', 'name'])->count();
    ...
    public function account()
    {
        ...
        } elseif (auth()->user()->email == 'neo.essaywriting') {
            $competitions = Competition::where('name', 'Essaywriting')->get();
    ...
    public function withdrawal()
    {
        if (auth()->user()->email == 'neo.debate') {
            ...
            $registrationDetails = RegistrationDetail::onlyTrashed()->whereRelation('competition', 'name', 'Essaywriting')->get();
        } elseif (auth()->user()->email == 'neo.ssw') {
