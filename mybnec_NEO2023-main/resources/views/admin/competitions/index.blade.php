<x-app title="Competitions | NEO 2022">
    ...
    <div class="container p-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="m-0 fw-semibold " style="color:#38AAC4;">Competition List</h4>
            <a type="button" href="{{ route('competitions.create') }}" class="btn " style="background-color:#38AAC4; color:white;">
                        ...
                        @foreach ($competitions as $competition)
                            <x-modal-confirmation action="destroy" title="Delete Competition" name="competitions"
                                ...
                                Are you sure want to delete <span
                                    class="fw-semibold">{{ $competition->name }}</span>?
                            ...
                            <tr class="m-5 p-5">
                                <td class="align-middle">
                                    <div class="row gx-3 my-3">
                                        ...
                                        {{-- <div class="col m-auto">
                                            ...
                                            <small>{{ $competition->link_group_whatsapp }}</small>
                                            <img src="/storage/images/competitions/QR/{{ $competition->qr_code_whatsapp }}"
                                                width="100%" class="rounded-3">
                                        </div> --}}
                                    </div>
                                </td>
                                <td class="align-middle">
                                    ...
                                    <span role="button" data-bs-toggle="tooltip" data-bs-title="Remaining quota">
                                        ...
                                        @if($isEarlyBirdOngoing == false)
                                        {{ $competition->total_quota - $competition->early_registrations_count - $competition->normal_registrations_count }}
                                        @else
                                            0
                                        @endif
                                    </span>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu p-1 border-0 shadow-sm rounded-3">
                                            ...
                                            @if ($competition->ebooklet)
                                                <li>
                                                    <a class="dropdown-item p-2 rounded-3"
                                                        href="{{ $competition->ebooklet }}" target="_blank">
