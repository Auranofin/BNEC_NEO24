                ...
                <div class="col-lg-12 d-lg-flex d-block align-items-center justify-content-center p-lg-0 p-5"
                    ...
                    <div class="col-lg-7 shadow d-flex flex-column justify-content-center" style="padding: 0px 120px;height:100vh">
                        <a class="d-flex justify-content-center mb-4" href="{{ route('home') }}">
                            <img src="/storage/logo/NEO-FULL/logo_neo_2024_colored.svg" alt="NEO" width="150"
                                class="img-fluid">
                        </a>
                        <div>
                            <p class="fs-1 text-center" style="font-family: Glacial-Bold;color:#38AAC4">
                                {{ __('Welcome Back, Voyagers!') }}</p>
                        </div>
...
<style>
    ...
    .shadow{
        box-shadow: 0 0.5rem 1rem rgba(72, 190, 241, 0.3) !important;
    }
</style>
