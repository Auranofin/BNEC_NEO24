    ...
    <div style="width: 100vw;height:100vh;display:flex; align-items:center">
        <div class="container-fluid p-0">
            <div class="d-lg-flex d-sm-block d-block">
                <div class="col-lg-5 d-lg-flex d-none align-items-center justify-content-center" style="background: #50cce8;height:100vh;border-radius: 0 120px 120px 0">
                    <div class="col-lg-7 m-auto">
                        <a class="d-flex justify-content-center mb-5" href="{{ route('home') }}">
                            <img src="/storage/logo/NEO-FULL/logo_neo_2024_colored.svg" alt="NEO" width="150" class="img-fluid">
                        </a>
                        <div>
                            <p class="fs-1 text-center" style="font-family: Glacial-Bold;color:white">{{ __('Ahoy, Voyagers!') }}</p>
                        </div>
                        <div>
                            <p class="text-white text-center">Enter your personal details with your registered account</p>
                        </div>
                        <div class="card bg-transparent" style="border:0mm">  
                ...
                <div class="col-lg-7 d-lg-flex d-block align-items-center justify-content-center p-lg-0 p-5" style="height:100vh;overflow-x: hidden">
                    <div class="col-lg-7 m-auto">
                        ...
                        <div>
                            <p class="fs-1 text-center" style="font-family: Glacial-Bold;color:#38AAC4">{{ __('REGISTER') }}</p>
                        </div>
