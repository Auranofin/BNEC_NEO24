    ...
    <div class="container">
        <table style="margin-bottom: 1rem;">
            <tbody>
                <tr>
                    <td colspan="2">
                        <img src="./storage/logo/BNEC/Colored.png" width="25%">
                    </td>
                </tr>
                <tr>
                    <td>
                        <p class="border-text">PAYMENT RECEIPT</p>
                    </td>
                    <td style="width: 30%">
            ...
            <tbody>
                @foreach ($competitions as $key => $competition)
                    <tr class="tbody">
                        ...
                        <td style="width: 50%">
                            PENDAFTARAN LOMBA
                            {{ $competition->name == 'Speech' ? strtoupper($competition->name) : strtoupper($competition->name) }}
        ...
        <table class="table-bank" style="margin-bottom: 3rem;">
            <tbody>
                ...
                <tr>
                    ...
                    <td>: DIANNE MANUELLA SOEGIANT</td>
                </tr>
                <tr>
        ...
        <div style="text-align: center;">
            <p>Approved By,</p>
            {{-- <img src="./storage/logo/NEO-FULL/Colored.png" width="20%"> --}}
            <img src="https://neo.mybnec.org/storage/images/assets/ttd_sashi.jpeg" width="20%" alt="Signed by Sashi Karina">
            <p>Sashi Karina</p>
