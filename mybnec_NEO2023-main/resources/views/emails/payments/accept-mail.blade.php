...
<head>
      ...
      <title>Accept Payment | {{ $payment->registration->user->name }}</title>
...
<body>
      ...
      <div class="body_email">
            <p>Thank you for registering for the National English Olympics 2023. We have received and approved your payment for competition registration.</p>
