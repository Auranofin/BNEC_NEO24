            ...
            <div class="d-lg-flex d-sm-block d-block">
                <div class="col-lg-7 d-lg-flex d-block align-items-center justify-content-center p-lg-0 p-5" style="height:100vh;overflow-x: hidden">
                    <div class="col-lg-7 m-auto">
                        ...
                        <div>
                            <p class="fs-1 text-center" style="font-family: Glacial-Bold;color:#38AAC4">{{ __('LOGIN') }}</p>
                        </div>
                ...
                <div class="col-lg-5 d-lg-flex d-none align-items-center justify-content-center" style="height:100vh;background: #50cce8;border-radius: 120px 0 0 120px">
                    <div class="col-lg-7 m-auto">
                        ...
                        <div>
                            <p class="fs-1 text-center" style="font-family: Glacial-Bold;color:white;border-radius:">{{ __('Ahoy, Voyagers!') }}</p>
                        </div>
                        <div>
