        ...
        <div class="card card-custom p-0 px-4 mb-3">
            <ul class="nav nav-tabs" id="registrationTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active text-muted" data-bs-toggle="tab" data-bs-target="#to-pay" type="button"
                        role="tab">
                        To pay
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link text-muted" data-bs-toggle="tab" data-bs-target="#to-verify" type="button"
                        role="tab">
                        To verify
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link text-muted" data-bs-toggle="tab" data-bs-target="#verified" type="button"
                        role="tab">Verified</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link text-muted" data-bs-toggle="tab" data-bs-target="#expired" type="button"
                        role="tab">Expired</button>
                </li>
                {{-- <li class="nav-item" role="presentation">
                    <button class="nav-link text-muted" data-bs-toggle="tab" data-bs-target="#refund" type="button"
                        role="tab">
                        Refund
        ...
        <div class="tab-content">
                ...
                @empty
                    <div class="card card-custom">
                        <div class="text-center mb-4">
                            <img src="/storage/images/assets/empty.svg" alt="No Registration Yet" width="20%">
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content border-0">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-6">
                                            <img src="/storage/images/payment_proofs/{{ $registration->payment->payment_proof }}"
                                                alt="{{ $registration->payment->proof }}" width="100%">
                                        </div>
                                        <div class="col">
                                            <div class="mb-3">
                                                <small class="text-muted">Payment Method</small>
                                                <h6>{{ $registration->payment->payment_method }}</h6>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <h6>
                                                    Rp {{ number_format($registration->payment->payment_amount, 0, '.', '.') }}
                                                </h6>
                                            </div>
            ...
            {{-- <div class="tab-pane fade" id="refund" role="tabpanel" tabindex="0">
                ...
                @empty
                    <div class="card card-custom">
                        <div class="text-center mb-4">
                            <img src="/storage/images/assets/empty.svg" alt="No Refund Yet" width="20%">
