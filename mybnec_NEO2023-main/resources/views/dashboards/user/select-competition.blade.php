...
<x-app title="Participant Registration | Select Competition">
      ...
      <div x-data="registration" x-cloak>
          <form method="POST" action="{{ route('registrations.create') }}">
              ...
              <div class="container py-5">
                  ...
                  <div class="alert mt-5 text-white text-center pt-3" role="alert" style="background: #D6E3E9;">
                      <p class="m-0" style="font-family: Glacial-Bold;color:#38AAC4;"><i class="bi bi-bell-fill"></i> DISCOUNT WEEK <i class="bi bi-bell-fill"></i></p>
                      <p class="m-0 fw-regular" style="color:#38AAC4;">{{ date('F j', strtotime($environment_early->start_time)) }}, 2023 -
                  ...
                  <p class="m-0 fs-4 fw-bold" style="color:#07485E">Please select the competition</p>
                          ...
                          <div class="col-md-6 mb-4 col-lg-3 col-sm-12 mx-auto">
                              <div class="card">
                                  <div class="d-flex flex-column justify-content-center text-center p-4">
                                      ...
                                      <div class="card-body">
                                          <h5 class="card-title glacialBold mb-3" style="color:#07485E">
                                              {{ $competition->name }}
                                          </h5>
                                          <h6 class="card-subtitle">
                                              ...
                                              <div>
                                                  <p class="fw-bold fs-5" x-show="getCompetition('{{ $competition->name }}').availableTickets > 0"
                                                      x-text="idrFormat.format(getCompetition('{{ $competition->name }}').price)" style="color:#07485E">
                                                  </p>
                                              </div>
                                          ...
                                          <p class="card-text py-4" style="color:#07485E">
                                              {{ $competition->content }}
                                          </p>
                                          @if (
                          ...
                          <div class="row">
                              <div class="col my-auto d-none d-md-block">
                                  <h5 class="m-0 text-muted total-ticket-label glacialBold">
                                      <span x-text="getTotalTickets() > 0 ? getTotalTickets() : 'No'"  style="color:#07485E"></span> ticket(s)
                                      selected
                                  </h5>
                              </div>
  ...
  <style>
      ...
      .btn-orange {
          background-color: #38AAC4 !important;
          border-color: #38AAC4 !important;
      }
