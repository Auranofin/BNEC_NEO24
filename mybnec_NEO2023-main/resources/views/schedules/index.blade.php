<x-app title="Schedules | NEO 2022">
    ...
    <div class="container p-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="m-0 fw-semibold" style="color:#38AAC4">Schedule List</h4>
            <a type="button" href="{{ route('schedules.create') }}" class="btn" style="color:white; background-color:#38AAC4">
